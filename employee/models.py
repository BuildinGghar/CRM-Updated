...
class SalaryDetail(models.Model):
    ...
    # def __str__(self):
    #     return f"{self.Employee.firstName} - {self.month} - {self.days} {self.time} {self.net_amount} {self.pending_amount} {self.status} "
...
class workAssignments(models.Model):
    assignment_id = models.CharField(primary_key=True, max_length=20)
